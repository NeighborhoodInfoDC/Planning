...
%let keep_vars =
  ...
  /** HMDA **/
  nummrtgorighomepurch1_4m_1997-nummrtgorighomepurch1_4m_2005
  numconvmrtgorighomepurch_1997-numconvmrtgorighomepurch_2005 
  numsubprimeconvorighomepur_1997-numsubprimeconvorighomepur_2005 
  mrtgorigpurchowner1_4m_1997-mrtgorigpurchowner1_4m_2005
  /*numconvmrtgorigrefin_1997-numconvmrtgorigrefin_2005 numsubprimeconvorigrefin_2005*/
  NumMrtgOrig_vli_1997-NumMrtgOrig_vli_2005 
  NumMrtgOrig_li_1997-NumMrtgOrig_li_2005 
  NumMrtgOrig_mi_1997-NumMrtgOrig_mi_2005 
  NumMrtgOrig_hinc_1997-NumMrtgOrig_hinc_2005 
  NumMrtgOrig_Inc_1997-NumMrtgOrig_Inc_2005
  nummrtgorigwhite_1997-nummrtgorigwhite_2005
  nummrtgorigblack_1997-nummrtgorigblack_2005
  nummrtgorighisp_1997-nummrtgorighisp_2005
  nummrtgorigwithrace_1997-nummrtgorigwithrace_2005
  /** Police **/
...
data all_levels;
  ...
  ** Economy - housing **;
  ...
  %Pct_calc( var=Pctsubprimeconvorighomepur, num=numsubprimeconvorighomepur, den=numconvmrtgorighomepurch, from=1997, to=2005, year_only_lbl=Y )
  %Pct_calc( var=Pctmrtgorigpurchowner1_4m, num=mrtgorigpurchowner1_4m, den=nummrtgorighomepurch1_4m, from=1997, to=2005, year_only_lbl=Y )
  
  %Pct_calc( var=PctMrtgOrig_hinc, num=NumMrtgOrig_hinc, den=NumMrtgOrig_inc, from=1997, to=2005, year_only_lbl=Y )
  %Pct_calc( var=PctMrtgOrig_mi, num=NumMrtgOrig_mi, den=NumMrtgOrig_inc, from=1997, to=2005, year_only_lbl=Y )
  ...
  %Pct_calc( var=PctMrtgOrig_low, num=NumMrtgOrig_low, den=NumMrtgOrig_inc, from=1997, to=2005, year_only_lbl=Y )
    
  %Pct_calc( var=Pctmrtgorigblack, num=nummrtgorigblack, den=nummrtgorigwithrace, from=1997, to=2005, year_only_lbl=Y )
  %Pct_calc( var=Pctmrtgorigwhite, num=nummrtgorigwhite, den=nummrtgorigwithrace, from=1997, to=2005, year_only_lbl=Y )
  %Pct_calc( var=Pctmrtgorighisp, num=nummrtgorighisp, den=nummrtgorigwithrace, from=1997, to=2005, year_only_lbl=Y )
  ...
  ** Safety and security **;
  ...
  %Pct_calc( var=violent_crime_rate, num=crimes_pt1_violent, den=crime_rate_pop, from=2000, to=2006, mult=1000, year_only_lbl=Y )
  %Pct_calc( var=property_crime_rate, num=crimes_pt1_property, den=crime_rate_pop, from=2000, to=2006, mult=1000, year_only_lbl=Y )

  *violent_crime_rate_2006 = 1000 * crimes_pt1_violent_2006 / crime_rate_pop_2006;
  *property_crime_rate_2006 = 1000 * crimes_pt1_property_2006 / crime_rate_pop_2006;
...
proc download status=no
  data=all_levels 
  out=Planning.DC_nbrhds_2008_06;
...
%File_info( data=Planning.DC_nbrhds_2008_06, printobs=0, freqvars=geo )
