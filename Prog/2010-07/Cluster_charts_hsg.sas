...
ods tagsets.excelxp file="&_dcdata_path\planning\prog\2010-07\Cluster Tables\Cluster_charts_hsg_dat.xls" style=styles.minimal_mystyle  
      options( sheet_interval='page' );

ods listing close;

/*
%Output_sheet( sales_sf_2009 )
%Output_sheet( sales_condo_2009 )
%Output_sheet( r_mprice_sf_2009, fmt=thous. )
%Output_sheet( r_mprice_condo_2009, fmt=thous. )

%Output_sheet( NumMrtgOrigHomePurch1_4m_2008 )
%Output_sheet( Pcthighcostconvorigpurch_2008 )
%Output_sheet( Pctmrtgorigpurchowner1_4m_2008 )

%Output_sheet( PctMrtgOrig_hinc_2008 )
%Output_sheet( PctMrtgOrig_mi_2008 )
%Output_sheet( PctMrtgOrig_low_2008 )

%Output_sheet( Pctmrtgorigblack_2008 )
%Output_sheet( Pctmrtgorigwhite_2008 )
%Output_sheet( Pctmrtgorighisp_2008 )
*/

%Output_sheet( forecl_ssl_1Kpcl_sf_condo_2009 )
