...
data Cluster_xy_plots;
  ...
  price_chg = 100 * %annchg( r_mprice_sf_2000, r_mprice_sf_2009, 2009-2000 );
...
ods tagsets.excelxp file="&_dcdata_path\planning\prog\2010-07\Cluster_xy_plots_dat.xls" style=brown
      options( sheet_interval='page' );

%Output_sheet( price_chg, Pctmrtgorigpurchowner1_4m_2008 )
