...
ods tagsets.excelxp file="&_dcdata_path\planning\prog\2010-07\Cluster Tables\Cluster_charts_hlth_dat.xls" style=styles.minimal_mystyle  
      options( sheet_interval='page' );

ods listing close;

%Output_sheet( Pct_births_low_wt_2007 )
%Output_sheet( Pct_births_teen_2007 )
%Output_sheet( Pct_births_prenat_adeq_2007 )
%Output_sheet( Rate_deaths_heart_2007 )
%Output_sheet( Rate_deaths_cancer_2007 )
%Output_sheet( Rate_deaths_violent_2007 )
