...
%let data = Dc_nbrhds_2008_11;
%let out_file = &_dcdata_path\planning\prog\2008-11\Tables.rtf;
...
%macro Table( Sec1=, var1=, years1=, fmt1=comma10.1, 
  ...
  proc report data=Planning.&data nowd split='^';
    column geo 
...
ods rtf file="&out_file" style=Styles.Rtf_arial_8_5pt;
ods listing close;
...
%Table( 
  ...
  sec1="No. mortgages originated", var1=nummrtgorighomepurch1_4m, years1=1997 1998 1999 2000 2001 2002 2003 2004 2005 2006, fmt1=comma10.0,
  sec2="% mortgages from subprime lenders", var2=Pctsubprimeconvorighomepur, years2=1997 1998 1999 2000 2001 2002 2003 2004 2005 2006
)

%Table( 
  title="Economy - Housing (Home Purchase Mortgages)",
  sec1="% mortgages to owner-occupants", var1=Pctmrtgorigpurchowner1_4m, years1=1997 1998 1999 2000 2001 2002 2003 2004 2005 2006
)

%Table( 
  title="Economy - Housing (Home Purchase Mortgages by Income)",
  sec1="% high income borrowers", var1=PctMrtgOrig_hinc, years1=1997 1998 1999 2000 2001 2002 2003 2004 2005 2006,
  sec2="% middle income borrowers", var2=PctMrtgOrig_mi, years2=1997 1998 1999 2000 2001 2002 2003 2004 2005 2006,
  sec3="% very low/low income borrowers", var3=PctMrtgOrig_low, years3=1997 1998 1999 2000 2001 2002 2003 2004 2005 2006
)

%Table( 
  title="Economy - Housing (Home Purchase Mortgages by Race/Ethnicity)",
  sec1="% black non-Hispanic borrowers", var1=Pctmrtgorigblack, years1=1997 1998 1999 2000 2001 2002 2003 2004 2005 2006,
  sec2="% white non-Hispanic borrowers", var2=Pctmrtgorigwhite, years2=1997 1998 1999 2000 2001 2002 2003 2004 2005 2006,
  sec3="% Hispanic borrowers", var3=Pctmrtgorighisp, years3=1997 1998 1999 2000 2001 2002 2003 2004 2005 2006
)
...
%Table(
  ...
  sec1="Violent crimes reported per 1,000\~pop.", var1=violent_crime_rate, years1=2000 2001 2002 2003 2004 2005 2006 2007,
  sec2="Property crimes reported per 1,000\~pop.", var2=property_crime_rate, years2=2000 2001 2002 2003 2004 2005 2006 2007
)
